...
export class BlogComponent implements OnInit {
  ...
  blogs = [
    ...
    { 
      ...
      content: `<p>Late spring calls for elegant, soft tones. Think lavender mist, peach blossom, and matcha green — colors that feel fresh but not overwhelming.</p>
      <p>These designs are perfect for garden parties, brunch dates, or just when you want to feel put together without trying too hard.</p>
      <p>The key to classy May nails? Keep the shapes clean (almond or short squoval), stick to 2-3 colors max, and add just one accent nail if you want detail.</p>
      <p>Pro tip: A sheer glossy top coat makes any spring color look 10x more expensive.</p>`,
    ...
    { 
      id: 3, 
      title: '26 Elegant Old Money Nails for Summer 2026',
      fullTitle: '26 Elegant Old Money Nails for Summer 2026',
      date: 'June 28\'',
      badge: '💎 Quiet luxury',
      category: '~ OLD MONEY / LUXURY / MINIMAL',
      content: `<p>The "old money" aesthetic is all about understated elegance. Think creamy nudes, sheer pinks, and glossy finishes that look effortlessly expensive.</p>
      <p>This trend rejects loud logos and flashy designs. Instead, it focuses on perfect execution — clean cuticles, flawless shaping, and high-shine top coats.</p>
      <p>Colors that scream old money: milky white, beige, soft taupe, and barely-there pink. Shape matters too — almond and squoval are your best friends.</p>
      <p>Remember: If it looks like you tried too hard, it's not old money. The vibe should be "I woke up like this" — but better.</p>`,
      imageUrl: '/assets/blog-3-img.png',
      nailName: 'Old Money',
      nailDescription: 'Neutral tones, clean shapes, and timeless elegance that whispers wealth.'
    },
    { 
      id: 4, 
      title: '25 French Tip Nail Ideas That Feel Fresh (2026)',
      fullTitle: '25 French Tip Nail Ideas That Feel Fresh (2026)',
      date: 'July 1\'',
      badge: '✨ Modern classic',
      category: '~ FRENCH TIPS / TRENDING / FRESH',
      content: `<p>French tips are back — but not as you remember them. Say goodbye to thick, harsh white lines and hello to micro tips, colored edges, and unexpected twists.</p>
      <p>The 2026 French manicure is all about personalization. Try a sage green tip on a nude base, or a baby blue tip for summer vibes. Micro French (super thin lines) gives an instant lengthening effect.</p>
      <p>Want something bold? Go for double lines, asymmetrical tips, or even glitter edges. The classic French will never die — but it's definitely evolving.</p>
      <p>Hot take: A colored French tip on short square nails looks so much fresher than long coffin shapes right now.</p>`,
      imageUrl: '/assets/blog-1-img.png',
      nailName: 'Modern French',
      nailDescription: 'Colored tips, micro french, and unexpected twists on the timeless classic.'
    },
    { 
      id: 5, 
      title: '22 Short Nail Designs That Look Expensive',
      fullTitle: '22 Short Nail Designs That Look Expensive',
      date: 'July 5\'',
      badge: '🌟 Short queen',
      category: '~ SHORT NAILS / ELEGANT / GLOSSY',
      content: `<p>Short nails can look just as luxurious as long ones — sometimes even more. The secret? Perfect execution and the right finish.</p>
      <p>Glossy top coat is non-negotiable. Shine makes short nails look polished and healthy. Matte finishes can work, but only on very clean, perfect shapes.</p>
      <p>Designs that work best on short nails: single color with high shine, micro French tips, negative space accents, and vertical lines (they create length illusion).</p>
      <p>What to avoid on short nails? Horizontal stripes, giant gems, and anything too busy. Keep it clean, keep it glossy, keep it expensive-looking.</p>`,
      imageUrl: '/assets/blog-2-img.png',
      nailName: 'Short Luxury',
      nailDescription: 'Proving that length doesn\'t define elegance — these short designs feel rich.'
    },
    { 
      id: 6, 
      title: '18 Butter Cream Nail Ideas Having a Moment',
      fullTitle: '18 Butter Cream Nail Ideas Having a Moment',
      date: 'July 10\'',
      badge: '🧈 Viral',
      category: '~ BUTTER NAILS / CREAMY / TRENDING',
      content: `<p>Butter yellow is the unexpected color taking over summer 2026. It's soft, warm, and somehow looks good on every skin tone.</p>
      <p>This isn't neon yellow or mustard — it's the creamy, pale yellow of actual butter. Think "lemon curd" vibes. It pairs beautifully with white, beige, and soft pink.</p>
      <p>Ways to wear butter nails: all-over color with glossy finish, butter French tips on nude base, or as an accent nail with other pastels.</p>
      <p>Celebrities are already obsessed, and TikTok has declared it the "clean girl summer" shade. Don't sleep on this trend — it's going to be everywhere by August.</p>`,
      imageUrl: '/assets/blog-3-img.png',
      nailName: 'Butter Cream',
      nailDescription: 'Creamy, dreamy yellow shades that look good on every skin tone.'
    }
  ];
